...
//Also counts the number of people in the list (but it's useless for my program)
void addOrRemove(string names[],bool IDS[],ifstream & fileInput,int &peopleList)
{
...
//Write into temporary array with remove14 text file
    addOrRemove(addRemoveNames,addRemoveIDS,fin2,peopleCounter);
...
//Store values of assignW14.txt
    addOrRemove(addRemoveNames,addRemoveIDS,fin3,peopleCounter);
    
//Assigns spots to the people on the assignW14 list
     for(int i=0;i<10;i++)
     {
...
1           Yiu_Fiona 6
1       Rennick_Chris 7
0    Carnovale_Andrew 25
0       Younes_Khaled 26
0           Chan_Gary 27
0      Strobel_Kieran 28
0          Pham_Nancy 29
0     Kraemer_Stephen 30
0         Dhir_Saajan 31
0       Fisher_Wesley 32
0        Taylor_Derek 33
0    Histon_Johnathan 42
*/
